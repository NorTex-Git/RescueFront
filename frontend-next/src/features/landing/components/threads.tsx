...
// @ts-nocheck
'use client'
// Componente vendored de React Bits (fondo WebGL "Threads", basado en ogl). Se mantiene
// tal cual del upstream; por eso va sin tipos ni lint. Cargar solo en cliente.
